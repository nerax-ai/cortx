    ...
    store.dispatch({
      ...
      usage: {
        ...
        context: {
          ...
          model: 'test-model',
          breakdown: [
            { key: 'messages', label: 'Messages', tokens: 40, source: 'runtime_estimate' },
            { key: 'tools', label: 'Tools', tokens: 30, source: 'runtime_estimate' },
            { key: 'skills', label: 'Skills', tokens: 20, source: 'runtime_estimate' },
            { key: 'system_prompt', label: 'System Prompt', tokens: 10, source: 'runtime_estimate' },
